  ...
  return (
    <div className="mx-auto h-[1480px] max-w-[1170px] min-[1170px]:h-[930px]">
      <div className="relative mx-auto w-[400px] justify-center min-[1170px]:w-auto">
        <h2 className="font-dm-sans leading text-c1 h-[82px] text-[48px] font-bold tracking-tighter">
          Cool Ideas
        </h2>
        <div className="font-dm-sans text-c3 order-1 w-auto flex-shrink-0 flex-grow-0 text-[16px] font-normal leading-[24px]">

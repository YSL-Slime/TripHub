...
import HotelCardB from "../../../components/HotelListings/HotelCardB";
import Filter from "../../../components/HotelListings/Filter";
import { fetchPosts } from "../../../utils/apiMyBook"; // Import the data fetching function
      ...
      <div className="bg-[#fafafb]">
        <div className="flex items-center justify-between">
          <div className="flex flex-row items-center p-10">
            ...
            <p className="pl-2 text-caption-14 text-c4">My destinations</p>
          </div>
